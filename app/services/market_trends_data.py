...
def get_market_trends_context(user_id: str) -> Dict[str, Any]:
    ...
    # Real aggregation: skill frequency across every stored posting. A plain
    # Python loop rather than a $unwind/$group pipeline, since posting
    # volume is expected to stay small enough that this is simpler to read.
